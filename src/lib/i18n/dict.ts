...
export const DICT = {
  ...
  "order.scheduledCountdownLabel": {
    bg: "До началото на приготвянето",
    en: "Until preparation begins",
  },
  "order.scheduledForColon": { bg: "Заявен час: ", en: "Requested time: " },
  "order.days": { bg: "д", en: "d" },
